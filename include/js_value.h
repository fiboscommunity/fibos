...
namespace chain {
    ...
    fibjs::Variant js_variant(const fc::variant& var);
    fc::variant fc_value(fibjs::Isolate* isolate, const fibjs::JSValue& var);
    ...
    inline fibjs::result_t string_to_name(fibjs::Isolate* isolate, fibjs::JSValue v, uint64_t& retVal)
    {
        fibjs::result_t hr;
        exlib::string str;

        hr = fibjs::GetArgumentValue(isolate, v, str);
        if (hr < 0)
            return hr;
